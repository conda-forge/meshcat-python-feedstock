...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/meshcat-python-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12256&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/meshcat-python-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `meshcat-python` can be installed with:

```
conda install meshcat-python
```

It is possible to list all of the versions of `meshcat-python` available on your platform with:
